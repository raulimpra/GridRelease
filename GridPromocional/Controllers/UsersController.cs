...
namespace GridPromocional.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        private readonly IUploadService<PgCatManagersOthers, PgStgCatManagersOthers> _upload;
        private readonly GridContext _context;

        public UsersController(ILogger<UsersController> logger
            , IUploadService<PgCatManagersOthers, PgStgCatManagersOthers> upload
            , GridContext context)
        {
            _logger = logger;
            _upload = upload;
        ...
        public async Task<IActionResult> UploadFile()
        {
            ...
            _upload.CsvService.Lookups.Add("Estemp", _context.PgCatStatusEmployee.ToDictionary(c => c.Estemp, c => (object)c.Estemp));
            ...
            foreach (var file in files)
            {
                try
                {
                    ...
                    _upload.ValidateDuplicates(x => x.Colemp);
        ...
        {
            var results = await _upload.UpdateUserList(truncate, x => x.Colemp, x => x.Target.Estemp == "A", x => x.Target.Estemp == "B");
